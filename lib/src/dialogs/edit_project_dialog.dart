          ...
          child: SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  appTextField('Project Name', nameCtl, required: true, hint: 'e.g., Main St Improvements'),
                  const SizedBox(height: 10),
                  appTextField('Client', clientCtl, required: true, hint: 'e.g., City of Anywhere'),
                  const SizedBox(height: 10),
                  appTextField('Contract Amount', contractCtl,
                      hint: 'e.g., 150000.00', keyboardType: TextInputType.number),
                  const SizedBox(height: 16),

                  // Contact block (NEW)
                  Align(
                    alignment: Alignment.centerLeft,
                    child: Text('Client Contact', style: Theme.of(context).textTheme.titleMedium),
                  ),
                  const SizedBox(height: 8),
                  appTextField('Contact Name', contactNameCtl, hint: 'e.g., Jane Smith'),
                  const SizedBox(height: 10),
                  appTextField('Contact Phone', contactPhoneCtl, hint: 'e.g., (555) 123-4567'),
                  const SizedBox(height: 10),
                  appTextField('Contact Email', contactEmailCtl, hint: 'e.g., jane@example.com'),
                ],
              ),
            ),
          ),
        ...
        actions: [
          ...
          FilledButton(
            onPressed: () async {
              ...
              if (nameCtl.text.trim().isEmpty || clientCtl.text.trim().isEmpty) {
